    ...
    return (<>
        <PushNotificationLayout>
            ...
            {/* <ComponentOne
                ...
                handleOrderNow={handleOrderNow}
            />
            {landingPageData?.promotion_banners?.length > 0 && <Banners landingPageData={landingPageData} isSmall={isSmall}/>}
            <ComponentTwo
                configData={configData}
                landingPageData={landingPageData}
            />
            ...
            {
                (landingPageData?.business_title || landingPageData?.business_sub_title || landingPageData?.business_image) && <AppDownloadSection
                    configData={configData}
                    landingPageData={landingPageData}
                />
            } */}
